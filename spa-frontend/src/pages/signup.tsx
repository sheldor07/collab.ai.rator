import loginSvg from "./../assets/Group 37297.svg";
  ...
  return (
    <div className="grid h-screen grid-cols-2 bg-white">
      <div className="mx-32 mt-12 text-center">
        ...
        <h2 className="mt-5 text-sm text-slate-400">
          {" "}
        ...
        <form className="p-8 mt-10 shadow-lg rounded-xl">
          <div className="mb-8">
            <label
              className="block mb-4 text-sm font-normal text-left text-gray-700 "
              htmlFor="email">
              Email address
            </label>
            <input
          ...
          <div className="mb-8">
            <label
              className="block mb-4 text-sm font-bold text-left text-gray-700"
              htmlFor="password">
              Password
            </label>
            <input
          ...
          <div className="flex flex-col">
            ...
            <a className="mt-4 text-sm font-light text-slate-400" href="#">
              Forgot Password?
            </a>
